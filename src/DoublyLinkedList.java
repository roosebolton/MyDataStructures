...
//contstructor for empty DoublyLinkedList
public DoublyLinkedList(){
  //sentinel Node at front
  header = new Node<E>(null,null,null);
  //sentinel Node at back that in empty DoublyLinkedList is preceded by the header
...
/**
*@return Returns size of the DoublyLinkedList
**/ 
public int size(){return size;}

/**
*@return Returns true if DoublyLinkedList is empty, false otherwise
**/
public boolean isEmpty(){return size==0;};

/**
*@return Returns first element E if DoublyLinkedList is not empty, null otherwise
**/
public E first(){
...
/**
*@return Returns last element E if DoublyLinkedList is not empty, null otherwise
**/
public E last(){
  if(isEmpty()){return null;}
  else{return 
...
public void addBetween(E element, Node<E> predecessor,Node<E> successor){
  ...
  //the size of the DoublyLinkedList has increased by 1
  size++;
}
...
public E remove(Node<E> node){
  ...
  //the size of the DoublyLinkedList has decreased by 1
  size--;
...
/**
*Adds element at front of DoublyLinkedList
**/
...
/**
*Removes and returns element from front of DoublyLinkedList, returns null if DoublyLinkedList is empty
...
/**
*Adds element at back of DoublyLinkedList
**/
...
/**
*Removes and returns element from back of DoublyLinkedList, returns null if DoublyLinkedList is empty
*@return Returns the element of the removed Node<E>
**/
public E removeLast(){
  if(isEmpty()){return null;}
